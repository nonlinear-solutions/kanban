...
config :kanban, KanbanWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Xs0LzYEDdatf1bTGZ0VYKpbYEk5M8NLuYGVGAyAl8MtRYWONMLbvkawLiQ4gHWr9",
  watchers: [
...
config :kanban, KanbanWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/kanban_web/router\.ex$"E,
      ~r"lib/kanban_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
